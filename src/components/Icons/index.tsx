...
export default function ExperienceIcon() {
  return (
    <div className="relative mr-4 flex-shrink-0">
       <div className="w-4 h-4 rounded-full bg-green-500 absolute top-1.5 left-1/2 transform -translate-x-1/2"></div>
       <div className="w-0.5 h-full bg-gray-300 absolute top-5 left-1/2 transform -translate-x-1/2"></div>
     </div>
  )
}
